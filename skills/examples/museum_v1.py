...
custom assets. Worked example: see museum.md beside this file. Companion to the small sculpture
gallery in scenes/work/museum.py; this one is the BIG room.
