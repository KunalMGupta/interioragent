---
id: workflow:vlm_feedback
kind: collection
role: "Feedback heuristics + the Decision log: one atomic lesson per entry, parsed as lesson:vlm/<slug>"
---
...
- **[living_room v1]** {#vlm-living-room-v1} `RoomProportions` drifted as occupancy rose:
...
- **[living_room v1, orientation]** {#vlm-living-room-v1-orientation} The two flanking accent chairs were placed with
...
- **[dental_office v1, room size]** {#vlm-dental-office-v1-room-size} `rescale room by 0.8` (Ph1) → `0.85` (Ph2). → **Held
...
- **[dental_office v1, rotation]** {#vlm-dental-office-v1-rotation} Every phase emitted `rotate dental unit / stool / cart
...
- **[dental_office v1, wall overlap]** {#vlm-dental-office-v1-wall-overlap} `front_wall slot 'right' has Door + Window` — the
...
- **[bar/lounge, lighting]** {#vlm-bar-lounge-lighting} `add_lighting("a row of warm pendant lights", density=0.4)` over the bar
...
- **[bar/lounge, room size]** {#vlm-bar-lounge-room-size} RoomProportions drifted `0.9 → 0.8 → 0.95` across the three phases. Held
  ...
  weak smoke alarm).
- **[casino v1, room size]** {#vlm-casino-v1-room-size} Final `RoomProportions` = `rescale room by 1.05` (occupancy a hair over the
...
- **[casino v1, place_on_top]** {#vlm-casino-v1-place-on-top} `hub.place_on_top("a stack of colorful casino poker chips")` retrieved a
...
- **[computer_room v1, on-top orientation]** {#vlm-computer-room-v1-on-top-orientation} `place_on_top(monitor)` baked a fixed rotation → the 8
...
- **[computer_room v1, desk+chair]** {#vlm-computer-room-v1-desk-chair} VLM again emitted a false-positive `rotate desk 180 / rotate chair
...
- **[computer_room v1, texture]** {#vlm-computer-room-v1-texture} floor came back **brown** for `"cool blue-grey anti-static vinyl
...
- **[computer_room v1, retrieval gaps]** {#vlm-computer-room-v1-retrieval-gaps} "computer desk" retrieved a **white marble console table** →
...
- **[computer_room v2, WorkstationGroup facing]** {#vlm-computer-room-v2-workstationgroup-facing} Rebuilt the stations on the reusable
...
- **[garage v1, room size]** {#vlm-garage-v1-room-size} RoomProportions drifted down `0.9` (Ph1) → `0.8` (Ph2). → **Held through
...
- **[garage v1, object proportions]** {#vlm-garage-v1-object-proportions} `rescale workbench by 0.5` (Ph1), but the render showed only a
...
- **[garage v1, car retrieval]** {#vlm-garage-v1-car-retrieval} "car" has **no retriever/pool** and routes to the generic retriever,
...
- **[children_room v1, room size]** {#vlm-children-room-v1-room-size} `RoomProportions` `0.83` → `0.85` → `0.92` → `0.9` across phases.
...
- **[children_room v1, bad scale metadata]** {#vlm-children-room-v1-bad-scale-metadata} A "large yellow bean bag" loaded at **0.15 m** (native
...
- **[children_room v1, wheeled "art"]** {#vlm-children-room-v1-wheeled-art} A "planets/stars" wall-art pick was a **wheeled easel/display**
...
- **[children_room v1, place_inside overflow]** {#vlm-children-room-v1-place-inside-overflow} Cubby baskets **overflowed** their compartments — the
...
- **[children_room v1, rotation]** {#vlm-children-room-v1-rotation} `rotate desk by 180 / rotate chair to face the desk / rotate
...
- **[executive_office v1, LIGHTING — the big one]** {#vlm-executive-office-v1-lighting-the-big-one} `add_lighting("a brass sputnik chandelier …")`
...
- **[executive_office v1, window = black void]** {#vlm-executive-office-v1-window-black-void} Same renderer limit as dental: any opening (window or
...
- **[executive_office v1, WorkstationGroup facing — reconfirmed]** {#vlm-executive-office-v1-workstationgroup-facing} For a single executive desk I wanted
...
- **[executive_office v1, converged rescale]** {#vlm-executive-office-v1-converged-rescale} `RoomProportions` walked `0.8 (no change other view)` →
...
- **[retail_store v1, lighting density scales with FLOOR AREA]** {#vlm-retail-store-v1-lighting-density-scales-with} `add_lighting(..., density=0.3)` —
...
- **[retail_store v1, storefront = worst-case black void]** {#vlm-retail-store-v1-storefront-worst-case-black} `place_window_floor_to_ceiling("front_wall")`
...
- **[retail_store v1, converged in 3]** {#vlm-retail-store-v1-converged-in-3} render1 (void + 40-disc grid) → window+density fixes; render2
...
- **[jewelry_shop v1→v2, a shop reads by its PRODUCT, not its fixtures — the user caught what the
  VLM couldn't]** {#vlm-jewelry-shop-v1-v2-a-shop-reads-by-its-produ} No velvet jewelry bust exists (~0.5 → decorative sculptures, recall ≠ quality, the
...
- **[jewelry_shop v1, pin anything whose COLOUR carries the palette]** {#vlm-jewelry-shop-v1-pin-anything-whose-colour-ca} The accent armchair was left
...
- **[jewelry_shop v1, converged in 2 via pattern reuse]** {#vlm-jewelry-shop-v1-converged-in-2-via-pattern-r} Copied the retail "central piece + perimeter
...
- **[coffee_shop v1, floating mesh with off-center origin]** {#vlm-coffee-shop-v1-floating-mesh-with-off-center} The walnut storage bench
...
- **[coffee_shop v0, lighting density on a SMALL room]** {#vlm-coffee-shop-v0-lighting-density-on-a-small-r} `add_lighting(flush, density=0.05)`
...
- **[laundromat v1, room size — a SPARSE room may shrink below 1.0]** {#vlm-laundromat-v1-room-size-a-sparse-room-may-sh} `RoomProportions`
...
- **[laundromat v1, clean by construction]** {#vlm-laundromat-v1-clean-by-construction} `no rotation` / `no wall overlap` every
...
- **[hospital_room v1, half-scale hero mesh]** {#vlm-hospital-room-v1-half-scale-hero-mesh} The pinned hospital bed rendered TOY-sized
...
- **[hospital_room v1, floating vanity]** {#vlm-hospital-room-v1-floating-vanity} `[Lint] vanity FLOATS 0.14 m` on the first
...
- **[hospital_room v1, place_arc chairs]** {#vlm-hospital-room-v1-place-arc-chairs} `rotate left/right armchair to face the
...
- **[hospital_room v1, ONE overloaded wall inflates the room — the shrink vote can't fix it]** {#vlm-hospital-room-v1-one-overloaded-wall-inflate}
...
- **[hospital_room v1, REVERSED-front vanity — user catch, VLM-invisible]** {#vlm-hospital-room-v1-reversed-front-vanity-user} The sink
...
- **[hospital_room v1, tall furniture occluding wall art → NEW auto constraint]** {#vlm-hospital-room-v1-tall-furniture-occluding-wa} After the
...
- **[music_studio v1, room size — a flip across neutral after acting = STOP]** {#vlm-music-studio-v1-room-size-a-flip-across-neut} `rescale room by
...
- **[music_studio v1, lighting lint at the "safe" density]** {#vlm-music-studio-v1-lighting-lint-at-the-safe-de} `add_lighting(flush, density=0.02)`
...
- **[music_studio v1, clean rotation by construction]** {#vlm-music-studio-v1-clean-rotation-by-constructi} `no rotation` every build on an
  ...
  rotation churn.
- **[music_studio v1, texture accent didn't take — carry the accent with a prop]** {#vlm-music-studio-v1-texture-accent-didn-t-take-c} Wall texture
...
- **[living_room_cozy v1, room size — a vote that NEVER flips is signal]** {#vlm-living-room-cozy-v1-room-size-a-vote-that-ne} `RoomProportions` voted
...
- **[living_room_cozy v1, phantom-object rotation noise]** {#vlm-living-room-cozy-v1-phantom-object-rotation} Phase 1 emitted `rotate left accent
...
- **[living_room_cozy v1, corner mesh at a wall center]** {#vlm-living-room-cozy-v1-corner-mesh-at-a-wall-ce} The audit-pinned fireplace (best fire
  ...
  caught by eye.
- **[living_room_cozy v1, rug size vs cluster bbox]** {#vlm-living-room-cozy-v1-rug-size-vs-cluster-bbox} `place_rug(size=1.0)` under a seating group
...
- **[classroom v1, room size — oscillation ends the thread]** {#vlm-classroom-v1-room-size-oscillation-ends-the} `RoomProportions` walked `0.96` →
...
- **[classroom v1, accent color in a texture string]** {#vlm-classroom-v1-accent-color-in-a-texture-strin} `wall_texture="white painted wall with one
...
- **[classroom v1, black ceiling is the renderer, not a texture]** {#vlm-classroom-v1-black-ceiling-is-the-renderer-n} The ceiling rendered BLACK in
...
- **[classroom v1, clean-by-construction orientation]** {#vlm-classroom-v1-clean-by-construction-orientati} `no rotation` + `no wall overlap` from the
...
- **[bookstore v1, decaying rescale vote = converged]** {#vlm-bookstore-v1-decaying-rescale-vote-converged} `rescale room by 0.75` (Ph1) → `0.8` (Ph2)
...
- **[bookstore v1, lighting density mid-size calibration]** {#vlm-bookstore-v1-lighting-density-mid-size-calib} `density=0.04` — chosen as "medium
...
- **[corridor v1, the shrink vote NEVER goes quiet on a passage room]** {#vlm-corridor-v1-the-shrink-vote-never-goes-quiet} `rescale room by
...
- **[corridor v1, oversized wall furniture is an EYE catch, not a VLM signal]** {#vlm-corridor-v1-oversized-wall-furniture-is-an-e} Phase-1 render:
...
- **[corridor v1, texture-library gap: no b/w checkerboard]** {#vlm-corridor-v1-texture-library-gap-no-b-w-check} Four floor wordings: "glossy black
...
- **[corridor v1, add_lighting has no asset_id]** {#vlm-corridor-v1-add-lighting-has-no-asset-id} Static lint caught `add_lighting(...,
...
- **[corridor v1, a mirror reflecting the room looks like a wrong asset]** {#vlm-corridor-v1-a-mirror-reflecting-the-room-loo} The round wall mirror
...
- **[bakery v1, garbage interior view → hallucinated rotation flags]** {#vlm-bakery-v1-garbage-interior-view-hallucinated} A build whose back-wall
...
- **[bakery v1, room size — sparse-shop shrink, one step]** {#vlm-bakery-v1-room-size-sparse-shop-shrink-one-s} `rescale room by 0.87→0.77` drifting
...
- **[bakery v1, texture "wrong color" that ISN'T a wording problem]** {#vlm-bakery-v1-texture-wrong-color-that-isn-t-a-w} Walls rendered pale blush
...
- **[bakery v1, window-bar drift]** {#vlm-bakery-v1-window-bar-drift} `place_on_front(window_bar_group)` (front SLOT) left the
...
- **[living_room_cozy v2, THIN wall furniture drifts off its wall — core fix]** {#vlm-living-room-cozy-v2-thin-wall-furniture-drif} The wall-centered
...
- **[living_room_cozy v2, wall art faced the wall — caption≠front]** {#vlm-living-room-cozy-v2-wall-art-faced-the-wall} The back-wall photo grid
...
- **[office_modern v1, texture — a MATCHING bug and a RENDERING limit look identical, and you can
  tell them apart OFFLINE in 5 seconds]** {#vlm-office-modern-v1-texture-a-matching-bug-and} The plan's green wall took three wordings, and the two
...
- **[office_modern v1, design the wall so the CAMERA can see the room]** {#vlm-office-modern-v1-design-the-wall-so-the-came} The storage backbone
...
- **[office_modern v1, room size — one decisive application, then decline the BOUNCE]** {#vlm-office-modern-v1-room-size-one-decisive-appl} Vote train
...
- **[office_modern v1, the empty-frame trap caught at AUDIT time]** {#vlm-office-modern-v1-the-empty-frame-trap-caught} The rank-1 pick for a warm
...
- **[living_room_cozy v3, place_on_top seats items on the group ANCHOR — a lamp on the chair]** {#vlm-living-room-cozy-v3-place-on-top-seats-items}
  ...
  VLM loop missed.)
- **[prison_cell v1, the loop cannot see a WRONG-KIND object — floral curtains in a jail cell]** {#vlm-prison-cell-v1-the-loop-cannot-see-a-wrong-k}
...
- **[prison_cell v1, a phase-2 `place_on_top` gated OUTSIDE its `with` block silently never runs]** {#vlm-prison-cell-v1-a-phase-2-place-on-top-gated}
...
- **[prison_cell v1, the float lint's false-positive class: `bottom=` wall-mounts]** {#vlm-prison-cell-v1-the-float-lint-s-false-positi} `[Lint]
...
- **[prison_cell v1, room size — read the vote TRAIN, then stop]** {#vlm-prison-cell-v1-room-size-read-the-vote-train} `rescale room by 0.69` (Ph1) →
...
- **[prison_cell v1, check a wall object's AABB bottom BEFORE hanging it — the rejected hatch]** {#vlm-prison-cell-v1-check-a-wall-object-s-aabb-bo}
...
- **[operating_room v1, room size — shrink the shell, but stay ABOVE the vote when the empty
  floor is FUNCTIONAL]** {#vlm-operating-room-v1-room-size-shrink-the-shell} `RoomProportions` voted `0.8` (Ph1) → `0.69` (Ph2) → `0.8` (full).
  ...
  never onto it.**
- **[operating_room v1, "that fixture is too small to be the thing it is" — no signal fires]** {#vlm-operating-room-v1-that-fixture-is-too-small}
...
- **[operating_room v1, the VIBE layer is INVERTED for a clinical room]** {#vlm-operating-room-v1-the-vibe-layer-is-inverted} The judge gate's
...
- **[operating_room v1, browse before believing the catalog's gap warning — but believe it when
  it's right]** {#vlm-operating-room-v1-browse-before-believing-th} The catalog flags operating tables as a prime ingest candidate; a browse found a
...
- **[kindergarten v1, a prop the dataset DOESN'T have — the clean loop can't see semantics]** {#vlm-kindergarten-v1-a-prop-the-dataset-doesn-t-h}
  ...
  that it does.**
- **[kindergarten v1, room size — "fill the floor, THEN shrink"]** {#vlm-kindergarten-v1-room-size-fill-the-floor-the} `RoomProportions` ran
...
- **[kindergarten v1, a nook is a corner, not an island]** {#vlm-kindergarten-v1-a-nook-is-a-corner-not-an-is} `place_on_left(reading_nook)` — a
...
- **[kindergarten v1, kid scale IS the camera rule — rotation-clean by construction]** {#vlm-kindergarten-v1-kid-scale-is-the-camera-rule} Every
  ...
  disappears.
- **[kindergarten v1, the picker's #1 for a kid chair is an OFFICE chair]** {#vlm-kindergarten-v1-the-picker-s-1-for-a-kid-cha} *"a small colourful
...
- **[tv_studio v1, a gap-category hero hides behind a DISMISSIVE caption — hunt by SILHOUETTE]** {#vlm-tv-studio-v1-a-gap-category-hero-hides-behin}
...
- **[tv_studio v1, you cannot hang a big backdrop — the two wall paths trap you from both sides]** {#vlm-tv-studio-v1-you-cannot-hang-a-big-backdrop}
...
- **[tv_studio v1, `modulate_scale` is a NO-OP on `place_on_top` items]** {#vlm-tv-studio-v1-modulate-scale-is-a-no-op-on-pl} The desk mics read
...
- **[tv_studio v1, orient a whole equipment LANE with `facing=`, never with a nested group]** {#vlm-tv-studio-v1-orient-a-whole-equipment-lane-w} v1 built
  ...
  baked rotation.
- **[greenhouse v1, the "black void" and the "black ceiling" were ONE renderer bug — now FIXED]** {#vlm-greenhouse-v1-the-black-void-and-the-black-c}
...
- **[greenhouse v1, room size — apply the SIGNAL, not the NUMBER]** {#vlm-greenhouse-v1-room-size-apply-the-signal-not} Vote ran `0.88 → 0.82 → 0.7`,
...
- **[greenhouse v1, retrieval scale metadata lies on plants too]** {#vlm-greenhouse-v1-retrieval-scale-metadata-lies} The pinned "tall tropical palm"
...
- **[kitchen v1, a bloated CLUSTER — not the item count — is what auto-sizes a cavernous room]** {#vlm-kitchen-v1-a-bloated-cluster-not-the-item-co}
...
- **[kitchen v1, deliberately UNDER-shrinking the vote on a fixed-size-row room]** {#vlm-kitchen-v1-deliberately-under-shrinking-the} The final vote was
...
- **[kitchen v1, the `place_rectilinear` stool-rotation false positive — declined, again]** {#vlm-kitchen-v1-the-place-rectilinear-stool-rotat}
...
- **[kitchen v1, the loop went clean on a room with two visible defects]** {#vlm-kitchen-v1-the-loop-went-clean-on-a-room-wit} Final build: `no rescale /
  ...
  gut-check is yours.**
- **[wine_cellar v1, "warm dim" is a BUDGET problem — no fixture choice can produce a dark room]** {#vlm-wine-cellar-v1-warm-dim-is-a-budget-problem}
...
- **[wine_cellar v1, the on-top prop band is NARROW — bracket it, don't creep]** {#vlm-wine-cellar-v1-the-on-top-prop-band-is-narro} The decanter/bottle
...
- **[wine_cellar v1, a washed-out texture can be a LIGHTING symptom]** {#vlm-wine-cellar-v1-a-washed-out-texture-can-be-a} The brick rendered pale pink.
...
- **[greenhouse v2, "this looks too much like the flower shop" — the DENSITY GRAIN differentiates two
  scenes that share a layout pattern (Kunal, 2026-07-13)]** {#vlm-greenhouse-v2-this-looks-too-much-like-the-f} v1 reused the florist recipe (mass a prop
...
- **[greenhouse v2, height-fitting a FLAT mesh detonates it]** {#vlm-greenhouse-v2-height-fitting-a-flat-mesh-det} Normalizing the bed's plants to a common
...
- **[kitchen_set v1, THE BLINDED-CAMERA TRAP — a solid-BLACK render that the loop calls clean]** {#vlm-kitchen-set-v1-the-blinded-camera-trap-a-sol}
  ...
  lever.
- **[kitchen_set v1, a shrink vote you must decline PERMANENTLY]** {#vlm-kitchen-set-v1-a-shrink-vote-you-must-declin} After the fix, `RoomProportions`
...
- **[kitchen_set v1, the SET-PIECE inverted vibe layer — phase 2 is deliberately EMPTY]** {#vlm-kitchen-set-v1-the-set-piece-inverted-vibe-l} A fitted
...
- **[kitchen_set v1, a wrong TEXTURE MATCH and a paled correct match look identical — settle it
  offline]** {#vlm-kitchen-set-v1-a-wrong-texture-match-and-a-p} The floor rendered salmon-pink for `"warm oak wood plank floor"`. Rather than guess a
...
- **[tv_studio v1, "no rotation" does NOT mean things are AIMED right — user catch]** {#vlm-tv-studio-v1-no-rotation-does-not-mean-thing} The two studio
...
- **[kitchen_set v2, ALIGNMENT is invisible to the whole loop — a fitted unit must go in a CORNER]** {#vlm-kitchen-set-v2-alignment-is-invisible-to-the}
...
- **[kitchen_set v2, two silent API traps that break a corner placement]** {#vlm-kitchen-set-v2-two-silent-api-traps-that-bre} (a) **`facing` is
...
- **[kitchen_set v2, a room-size vote you refute with ARITHMETIC, not taste]** {#vlm-kitchen-set-v2-a-room-size-vote-you-refute-w} With the set static
...
- **[operating_room v2, a user-supplied glb zip is NOT ingest-ready — three SILENT violations]** {#vlm-operating-room-v2-a-user-supplied-glb-zip-is}
...
- **[operating_room v2, an ingested asset's CAPTION and SCALE are both VLM guesses — trust
  neither]** {#vlm-operating-room-v2-an-ingested-asset-s-captio} The ingest VLM captioned the draped mayo stand a *"blue powder-coated drill press"*,
...
- **[operating_room v2, FILENAMES LIE — the preview is the evidence, and the yield is low]** {#vlm-operating-room-v2-filenames-lie-the-preview} All
...
- **[operating_room v2, the USER's "not enough relevant assets" diagnosis beat the clean VLM
  loop]** {#vlm-operating-room-v2-the-user-s-not-enough-rele} v1 converged fully clean (`no rotation / no wall overlap`, no lints, room vote settled)
...
- **[clothing_store v1, THE BIG ONE: an ingested scan's `scale` is a GUESSED WIDTH — big fixtures
  arrive as MINIATURES, and every reflex makes it worse]** {#vlm-clothing-store-v1-the-big-one-an-ingested-sc} The `ShopFixtureRetriever` customs are
...
- **[clothing_store v1, true-size fixtures trip the wall-centre camera rule constantly]** {#vlm-clothing-store-v1-true-size-fixtures-trip-th} An interior
...
- **[clothing_store v1, `bottom=` on wall-ADJACENT furniture always trips the floaters lint]** {#vlm-clothing-store-v1-bottom-on-wall-adjacent-fu}
...
- **[clothing_store v1, a fixture whose mesh has a GLASS backing hides its own product]** {#vlm-clothing-store-v1-a-fixture-whose-mesh-has-a}
...
- **[clothing_store v1, lighting density INVERTS with floor area — a 129 m² datapoint]** {#vlm-clothing-store-v1-lighting-density-inverts-w}
...
- **[clothing_store v1, "warm lighting" is the ENVELOPE, not the fixture]** {#vlm-clothing-store-v1-warm-lighting-is-the-envel} The brief asked for "warm
...
- **[clothing_store v1, don't crown a counter whose product is MODELLED IN — check the FREE surface,
  not the footprint]** {#vlm-clothing-store-v1-don-t-crown-a-counter-whos} The cash-wrap scan (`custom/eedaa74b…`) is 1.55 m tall *including* an
...
- **[art_studio v1, `place_on_top` SHATTERS on a SKELETAL anchor — and the loop calls it clean]** {#vlm-art-studio-v1-place-on-top-shatters-on-a-ske}
...
- **[art_studio v1, ANCHOR A UNIT ON THE PIECE WHOSE FACING CARRIES THE READ]** {#vlm-art-studio-v1-anchor-a-unit-on-the-piece-who} Having moved the
...
- **[art_studio v1, "FILL THE FLOOR INSTEAD OF SHRINKING" IS NOT UNIVERSAL — a fill that claims a ROW
  grows the shell]** {#vlm-art-studio-v1-fill-the-floor-instead-of-shri} The shrink vote ran `0.75 / 0.7 / 0.81 / 0.5 / 0.7 / 0.65 / 0.75` — unidirectional,
...
- **[art_studio v1, a rotation vote on a ROTATIONALLY SYMMETRIC object is self-identifying noise]** {#vlm-art-studio-v1-a-rotation-vote-on-a-rotationa}
...
- **[laboratory v1, an ingested mesh whose ORIGIN is 118% of its height off-centre — and the
  ingest batch's UNUSED meshes are all still broken]** {#vlm-laboratory-v1-an-ingested-mesh-whose-origin} The microscope — the one prop that makes
...
- **[laboratory v1, a `0.5` shrink vote that was not about room size at all]** {#vlm-laboratory-v1-a-0-5-shrink-vote-that-was-not} Phase 1 voted
...
- **[laboratory v1, "the dataset has no X" can be false while X sits in the pool — grep `custom/`
  by hand]** {#vlm-laboratory-v1-the-dataset-has-no-x-can-be-fa} A 36-query stress test returned **`0.000` — an EMPTY candidate list, not a bad pick —
...
- **[laboratory v1, the GRID is not the category — the PRODUCT is]** {#vlm-laboratory-v1-the-grid-is-not-the-category-t} classroom, computer_room and
...
- **[waiting_room v1, a back-centre print behind a reception desk is ALWAYS crossed by the monitor —
  and the fix is ASPECT, not size]** {#vlm-waiting-room-v1-a-back-centre-print-behind-a} The focal print hung at `place_on_wall_back_center` came back with
...
- **[waiting_room v1, the EMPTY-FRAME trap is not just picture frames — a wall CLOCK can be a blank
  disc]** {#vlm-waiting-room-v1-the-empty-frame-trap-is-not} Adding the clock (the one prop that says *waiting room* — you watch it while you wait), the
  ...
  the gate.**
- **[waiting_room v1, "rows of linked chairs" has no mesh — PACK a GridGroup instead]** {#vlm-waiting-room-v1-rows-of-linked-chairs-has-no} The hero of the
...
- **[waiting_room v1, the plan's material rendered as a BLACK MONOLITH — form factor is an eye catch]** {#vlm-waiting-room-v1-the-plan-s-material-rendered}
  ...
  *"that reads as a black box"* is semantics. Caught in the **cheap phase-1 loop** and swapped for an
  ...
  category."
- **[waiting_room v1, room size — fill the floor, then stop SHORT of the vote on a row-packed room]** {#vlm-waiting-room-v1-room-size-fill-the-floor-the}
...
- **[closet v1, the shrink vote was RIGHT that the room was wrong and WRONG about the fix]** {#vlm-closet-v1-the-shrink-vote-was-right-that-the}
...
- **[closet v1, the residual vote bounced across IDENTICAL builds — declined permanently]** {#vlm-closet-v1-the-residual-vote-bounced-across-i} After
...
- **[closet v1, the float lint's OTHER false-positive class: a mesh authored as a WALL unit]** {#vlm-closet-v1-the-float-lint-s-other-false-posit}
...
- **[closet v1, uniform scaling couples W to H — so a mesh's ASPECT can be the defect]** {#vlm-closet-v1-uniform-scaling-couples-w-to-h-so} The closet
...
- **[closet v1, the camera rule applied PREVENTIVELY — four clear views on the first build]** {#vlm-closet-v1-the-camera-rule-applied-preventive}
...
- **[dining_room v1, the brightness dial FLIPS at phase 3 — it is the light BUDGET, not the sky]** {#vlm-dining-room-v1-the-brightness-dial-flips-at}
  ...
  lever is broken.
- **[dining_room v1, TOOLING — `IDSDL_SKY` in the program is a no-op under WORKBENCH too, not just MCP]** {#vlm-dining-room-v1-tooling-idsdl-sky-in-the-prog}
...
- **[dining_room v1, a room-size vote that never leaves ±5% is noise, not a train]** {#vlm-dining-room-v1-a-room-size-vote-that-never-l} `1.05` (Ph2) →
...
- **[dining_room v1, check a wall-art mesh's HEIGHT before you hang it over furniture]** {#vlm-dining-room-v1-check-a-wall-art-mesh-s-heigh} The gallery
...
- **[dining_room v1, the dining-table SET trap defused by the query]** {#vlm-dining-room-v1-the-dining-table-set-trap-def} Generic dining/cafe table
...
- **[grocery_store v1, the wall-centre camera rule is TOTAL — a 1.9 m run at a wall centre renders that
  view BLACK, under a perfectly clean feedback string]** {#vlm-grocery-store-v1-the-wall-centre-camera-rule} v1 placed the stocked gondolas at
...
- **[grocery_store v1, the shell is the SUM of 5 column maxima — ONE wide group in ONE slot inflates the
  WHOLE room, and the shrink vote GROWS as you chase it]** {#vlm-grocery-store-v1-the-shell-is-the-sum-of-5-c} The plan asked for a "Produce Wall", so I
  ...
  **Rules: (a) an object placed in a column/row that something wider already occupies is FREE — slot for
  ...
  `modulate_scale`.**
- **[grocery_store v1, re-check `add_lighting` density AFTER a `modulate_scale`]** {#vlm-grocery-store-v1-re-check-add-lighting-densi} `density=0.02` was the
...
- **[grocery_store v1, a shop's produce/perishables have the jewelry_shop problem — the FIXTURES are all
  empty]** {#vlm-grocery-store-v1-a-shop-s-produce-perishable} The `ShopFixtureRetriever` pool made the *dry* goods free (a genuinely stocked supermarket
...
- **[laundry_room v1, the shell is fixed with SLOTS — and the PLAN already told me which one]** {#vlm-laundry-room-v1-the-shell-is-fixed-with-slot} Phase-1
...
- **[laundry_room v1, `place_inside` cannot carry a category read — the product goes on the LOW anchor]** {#vlm-laundry-room-v1-place-inside-cannot-carry-a}
...
- **[laundry_room v1, the BRIGHT-room mirror of wine_cellar — and an overexposed render is a GARBAGE
  render]** {#vlm-laundry-room-v1-the-bright-room-mirror-of-wi} The first full build **blew out to pure white** (the tile floor vanished) the moment phase 3
  ...
  it tells you.**
- **[laundry_room v1, a room-size vote BELOW the arithmetic floor]** {#vlm-laundry-room-v1-a-room-size-vote-below-the-a} Vote `0.80` at the end of phase 2. But
...
- **[grocery_store v1, the miniature-scan trap CONFIRMED on a second scene — and it is what the
  never-quiet shrink vote was really saying]** {#vlm-grocery-store-v1-the-miniature-scan-trap-con} Independently of clothing_store, three of this scene's
...
- **[fast_food v1, the vote flipped OFF a converged shell — one prop cannot resize a room]** {#vlm-fast-food-v1-the-vote-flipped-off-a-converge} The full
...
- **[fast_food v1, two wall-opening traps the static lint cannot catch — both cost a full build]** {#vlm-fast-food-v1-two-wall-opening-traps-the-stat}
...
- **[nursery v1, an ALL-WHITE room is an EXPOSURE trap — the loop is silent on it]** {#vlm-nursery-v1-an-all-white-room-is-an-exposure} The first full
...
- **[nursery v1, TOOLING — `IDSDL_SKY` works from the SHELL, is IGNORED by MCP `run_scene` (A/B on the
  same file)]** {#vlm-nursery-v1-tooling-idsdl-sky-works-from-the} Confirms wine_cellar's gotcha and **corrects** the dining_room README note that says the
...
- **[nursery v1, a PASTEL wall texture fails twice — and in the OPPOSITE direction to the known trap]** {#vlm-nursery-v1-a-pastel-wall-texture-fails-twice}
...
- **[nursery v1, a BLANK desc in the asset list is a self-identifying junk pick]** {#vlm-nursery-v1-a-blank-desc-in-the-asset-list-is} The unpinned
...
- **[nursery v1, bad PROPORTIONS cannot be scaled away — swap the mesh (vs. bad SCALE, which you fix)]** {#vlm-nursery-v1-bad-proportions-cannot-be-scaled}
...
- **[nursery v1, a prop can EXIST and still be UNPLACEABLE — the crib mobile, a real DSL gap]** {#vlm-nursery-v1-a-prop-can-exist-and-still-be-unp} The most
...
- **[pantry v1, you CANNOT densely stock a tall rack with `place_inside` — adding goods makes it EMPTIER]** {#vlm-pantry-v1-you-cannot-densely-stock-a-tall-ra}
...
- **[pantry v1, don't trust `run_scene` on a busy box]** {#vlm-pantry-v1-don-t-trust-run-scene-on-a-busy-bo} The MCP `run_scene` tool returned a *Laboratory*
...
- **[closet v1, a wall shelf placed INSIDE a wardrobe — the overlap solver's blind spot, and a new
  core lint (Kunal, 2026-07-13)]** {#vlm-closet-v1-a-wall-shelf-placed-inside-a-wardr} The wall-mounted clothes shelf ended **0.45 m inside** the
...
- **[closet v1, "a fix that changes the numbers by exactly zero" is a falsified hypothesis]** {#vlm-closet-v1-a-fix-that-changes-the-numbers-by} My
...
- **[fast_food v1.1, three USER catches on a build the VLM loop called clean — and the pattern in them]** {#vlm-fast-food-v1-1-three-user-catches-on-a-build}
...
- **[art_studio v2, THE INGEST FIX PASS SILENTLY NO-OPS IF YOU SKIP `parent_clear` — and the
  audit that "verifies" it lies to you twice]** {#vlm-art-studio-v2-the-ingest-fix-pass-silently-n} Ran operating_room v2's prescribed Blender pass over
...
- **[art_studio v2, ONE CORRECT MESH DELETED ~40 LINES OF WORKAROUND — "clean but unconvincing"
  really does mean ASSETS, not placement]** {#vlm-art-studio-v2-one-correct-mesh-deleted-40-li} v1 was VLM-clean and still needed: a silhouette hunt to
...
- **[bedroom v1 (phase-gating retrofit), A ROOM-SIZE VOTE ON A PARTIAL BUILD IS VOTING ON A ROOM
  THAT DOES NOT EXIST YET]** {#vlm-bedroom-v1-phase-gating-retrofit-a-room-size} The same program, same seed: **full build → VLM-clean at
