...
6. **[workflow/constraints.md](workflow/constraints.md)** and **[workflow/vlm_feedback.md](workflow/vlm_feedback.md)** — keep open while optimizing. **[workflow/constraint_playbook.md](workflow/constraint_playbook.md)** is the per-asset WHICH-constraint catalog (DRAFT pending Kunal's review).
